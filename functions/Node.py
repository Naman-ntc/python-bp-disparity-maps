...
class PairWiseFactorNode(object):
	"""docstring for PairWiseFactorNode"""
	...
	def sendMessage(self, index):
		#print((self.messages[1-index].mean()))
		#return (self.messages[1-index][:,None] + self.smoothening*self.pairwiseCostMatrix).min(axis=0)
